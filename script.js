document.addEventListener('DOMContentLoaded', () => {
    ...
    if (typeof Typed !== 'undefined' && document.querySelector('.typing')) {
        new Typed('.typing', {
            strings: [
                'an AI Solutions Designer',
                'a Creative Problem Solver',
                'a Fullstack Developer',
                'a User-Centric Innovator',
                'a Software Engineer',
    ...
    radarChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [85, 80, 75, 70, 78, 88],
                backgroundColor: 'rgba(74, 130, 238, 0.2)',  // Brighter blue with opacity
                borderColor: 'rgba(74, 130, 238, 1)',      // Solid brighter blue
                borderWidth: 2,
                pointBackgroundColor: 'rgba(74, 130, 238, 1)',
                pointRadius: 5,
                pointHoverRadius: 7
            },
            {
                label: 'Learning Goals',
                data: [90, 90, 85, 85, 85, 90],
                backgroundColor: 'rgba(46, 204, 113, 0.1)',  // Keep this as is
                borderColor: 'rgba(46, 204, 113, 0.5)',     // Initial border color
                borderWidth: 1,
                borderDash: [5, 5],
                pointRadius: 0
            }]
